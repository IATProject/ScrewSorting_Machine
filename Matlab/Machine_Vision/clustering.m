...
[columnsInImage, rowsInImage] = meshgrid(1:img_size_x, 1:img_size_y);

centerX = img_size_x/2;
centerY = img_size_y/2;
radius = (img_size_x-50)/2;

mask_circle = (rowsInImage - centerY).^2 + (columnsInImage - centerX).^2 <= radius.^2;
