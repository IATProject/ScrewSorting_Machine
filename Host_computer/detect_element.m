...
parameter.binlevel = 0.9;       %binarize level
parameter.downsample = 0.5;     %downsample the image (washer,nut)
parameter.olapRatio_max = 0.15; %max overlap ratio between two bbox's
parameter.olapRatio_min = 0.7;  %min overlap ratio between two bbox's
parameter.scale = scale;        %scaling factor
parameter.res_D = 0.05;          %resolution in the calculation of the diameter
